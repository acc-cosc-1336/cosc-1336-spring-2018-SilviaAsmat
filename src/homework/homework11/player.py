...
class Player:
    ...
    def __init__(self, game_log, die1, die2):
        self.die1 = Die(6) #ASSIGNMENT12: update the statement to use the die1 parameter argument
        self.die2 = Die(8) #ASSIGNMENT12: update the statement to use the die2 parameter argument
